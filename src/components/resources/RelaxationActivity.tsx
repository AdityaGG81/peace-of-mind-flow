...
const natureSounds = [
  { id: 'rain', label: 'Rain', icon: Cloud, description: 'Gentle rainfall on leaves' },
  { id: 'ocean', label: 'Ocean', icon: Waves, description: 'Calming ocean waves' },
  { id: 'forest', label: 'Forest', icon: Leaf, description: 'Birds and rustling leaves' },
  { id: 'sunrise', label: 'Dawn', icon: Sun, description: 'Morning nature sounds' },
];

const colorTherapyColors = [
  { color: 'bg-blue-500', name: 'Calm Blue', emotion: 'Peace and tranquility' },
  { color: 'bg-green-500', name: 'Nature Green', emotion: 'Balance and growth' },
  { color: 'bg-purple-500', name: 'Wisdom Purple', emotion: 'Spirituality and creativity' },
  { color: 'bg-orange-400', name: 'Warm Orange', emotion: 'Joy and enthusiasm' },
  { color: 'bg-pink-400', name: 'Gentle Pink', emotion: 'Love and compassion' },
  { color: 'bg-yellow-400', name: 'Happy Yellow', emotion: 'Optimism and clarity' },
];
          ...
          <Tabs defaultValue="sounds" className="w-full">
            ...
            <TabsContent value="sounds" className="space-y-4">
              <div className="text-center mb-6">
                <h3 className="text-lg font-semibold mb-2">Nature Sound Therapy</h3>
                  ...
                  return (
                    <Card 
                      ...
                      className={`cursor-pointer transition-all duration-300 ${
                        isActive ? 'ring-2 ring-primary bg-primary/5 scale-105' : 'hover:bg-muted/50'
                      }`}
            ...
            <TabsContent value="colors" className="space-y-6">
              ...
              <div className="text-center space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">{currentColor.emotion}</p>
                </div>
                ...
                <div className="grid grid-cols-3 gap-2 max-w-xs mx-auto">
                  {colorTherapyColors.map((color, index) => (
                    <div
                      key={index}
                      className={`w-12 h-12 rounded-full ${color.color} cursor-pointer transition-transform hover:scale-110 ${
                        index === colorIndex ? 'ring-2 ring-primary scale-110' : ''
                      }`}
            ...
            <TabsContent value="affirmations" className="space-y-6">
              <div className="text-center mb-6">
                <h3 className="text-lg font-semibold mb-2">Positive Affirmations</h3>
                <p className="text-sm text-muted-foreground">
            ...
            <TabsContent value="breathing" className="space-y-6">
              <div className="text-center mb-6">
                <h3 className="text-lg font-semibold mb-2">Visual Breathing Guide</h3>
                <p className="text-sm text-muted-foreground">
